...
private class Games.KeyboardMappingMonitor: Object {
	...
	public KeyboardMappingMonitor (string joystick_directory) throws IOError {
		var directory = Application.get_gamepad_mappings_dir ();

		// Monitor the directory
		directory = File.new_for_path (directory);
